...
<html lang="en">
  ...
  <body>
    <div class="grid-container">
      <div class="grid-item">
        <div class="fa-stack icons" onclick="recode_mode('on2')">
      ...
      <div class="grid-item icons">
        <a href="./dashboard_mobile.php" class="fa-stack">
          <i class="fa fa-circle fa-stack-2x" style="color:#ADADAD;"></i>
      ...
      <div class="grid-item-narrow">
          <span class="deco DSEG14">back</span>
      </div>
    </div>
    ...
    <div class="grid-container">
      <div class="grid-item" onclick="recode_mode('up2')">
        <div class="fa-stack icons">
      ...
      <div class="grid-item"  onclick="recode_mode('b12')">
        <div class="fa-stack icons">
      ...
      <div class="grid-item" onclick="recode_mode('d2')">
        <div class="fa-stack icons">
      ...
      <div class="grid-item icons"  onclick="recode_mode('b22')">
        <div class="fa-stack">
